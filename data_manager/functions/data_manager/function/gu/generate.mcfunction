...
execute unless score @s gu.UUID0 = @s gu.UUID0 run function data_manager:gu/store_uuid_as_score
...
function data_manager:gu/get_hexes with storage gu:temp
function data_manager:gu/concat_uuid with storage gu:temp